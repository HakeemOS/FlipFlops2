...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/FlipFlops2/FlipFlops2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TFF_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TFF_s.tcl
